...
<body>
    ...
    <main>
        ...
        <div class="content-container">
            <h1 class="welcome-text" id="welcomeText" style="display: block;" aria-live="polite">
                ...
                <br>
                Thank you very much for your visit and we look forward to your feedback!
            </h1>
    ...
    <script>
        ...
        function updateTextLanguage(language) {
            const translations = {
                en: {
                    welcome: `<i class='fas fa-smile' style="animation: laugh 0.5s infinite;"></i> <br>Thank you very much for your visit and we look forward to your feedback!`,
                },
                de: {
                    welcome: `<i class="fas fa-smile" style="animation: laugh 0.5s infinite;"></i> <br>Danke für deinen Besuch und wir freuen uns auf deine Rückmeldung!`,
                }
            };
